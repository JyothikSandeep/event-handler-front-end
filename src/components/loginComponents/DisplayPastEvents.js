        ...
        return (
          <div className="border border-gray-300 p-4 rounded-md shadow-md bg-white hover:shadow-xl">
            ...
            <div className='flex ml-10'>
              ...
              <button className='p-2 rounded bg-gray-200 hover:bg-gray-400 shadow-xl ' onClick={()=>navigate("/admin/displayeventdetails",{state:d})}>View details</button>
                  </div>
            {/* {d.event_name} */}
          </div>
        );
...
export default DisplayPastEvents