...
const DisplayOngoingEvent = () => {
  const navigate = useNavigate();
  useEffect(()=>{
    async function getData(){
      const d = await axios.get("http://localhost:5000/admin/ongoingevents");
      console.log(d);
      setData(d.data);
    }
    getData()
  ...
  return (
    <>
      <h1 className="text-2xl text-center mt-8">On going Events</h1>
...
export default DisplayOngoingEvent